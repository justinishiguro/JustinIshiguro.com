        ...
        <div className="flex flex-col items-center">
          <div className="grid grid-cols-3 w-full">
            <div className="pt-8 pl-12">
              <div className="inline-block">
                <a
                  href="mailto:justin.ishiguro@gmail.com?subject=Database Project Code Request&body=*Since this is an academic project, I am unable to publicly upload the code to GitHub. Please email to request access to the source code.*%0A%0A"
                  target="_blank"
                  className="col-span-1 svg-link"
                >
                  <svg
            ...
            <h1 className="col-span-1 font-bold pt-4 text-md sm:text-2xl hover:text-gray-500 font-serif text-center">
              Muliplayer Video Game Database Project
            </h1>
          ...
          <p className="px-12 pt-4">
            As part of my Relational Database class (CPSC 304), I worked with two 
            other students to create an application using Java and Oracle to allow
            users to view the current state of a hypothetical multiplayer video game. 
            We began our project by creating a relational schema to plan the various 
            entities and attributes, including players, items, quests, and many others. 
            Then we began to write our SQL statements using SELECT, UPDATE, and INSERT
            operations. We also had to implement SQL functionalities such as Selection,
            Projection, Join, Group By, and Division to allow users to view and edit various 
            attributes.
            <br />
            <br />
            <span className="font-bold">
            ...
            From this database project, I was able to apply what I learned in class
            to create a functioning application. Being able to write the SQL statements
            for our specific project solidified my understanding of how relational 
            databases work and how users can interact with them through SQL.  
          </p>
        </div>
        <div className="flex flex-wrap text-sm whitespace-nowrap mx-12">
          <div className="border-[1px] border-blue-200 bg-blue-200 text-blue-800 rounded-2xl mr-2 mt-2 inline-block px-2">
